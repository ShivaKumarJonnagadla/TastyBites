...
async function main() {
    ...
    // Admin user
    const hashedPassword = await bcryptjs_1.default.hash('TastyBites@2024!', 12);
    ...
    const dishes = [
        // ── DISABLED: items removed from the menu ────────────────────────────
        {
            ...
            price: 100, isVegetarian: true, spiceLevel: client_1.SpiceLevel.MILD,
            menuType: client_1.MenuType.DAILY, category: 'Curries', isAvailable: false,
        },
        {
        ...
        },
        {
            ...
            price: 90, isVegetarian: true, spiceLevel: client_1.SpiceLevel.MILD,
            menuType: client_1.MenuType.DAILY, category: 'Curries', isAvailable: false,
        },
        {
            name: 'Samosa (2 pcs)',
            ...
            price: 40, isVegetarian: true, spiceLevel: client_1.SpiceLevel.MILD,
            menuType: client_1.MenuType.DAILY, category: 'Snacks', isAvailable: false,
        },
        {
            name: 'Puffs (Veg & Egg)',
            ...
            price: 20, isVegetarian: true, spiceLevel: client_1.SpiceLevel.MILD,
            menuType: client_1.MenuType.BOTH, category: 'Snacks', isAvailable: false,
        ...
        },
        {
            ...
            price: 130, isVegetarian: false, spiceLevel: client_1.SpiceLevel.HOT,
            menuType: client_1.MenuType.FRIDAY, category: 'Specialities', isAvailable: false,
        ...
        // ── Specialities (BOTH — shown in All Dishes AND Friday Special) ─────
        {
            ...
            price: 100, isVegetarian: false, spiceLevel: client_1.SpiceLevel.MEDIUM,
            menuType: client_1.MenuType.BOTH, category: 'Specialities', isAvailable: true,
        ...
        },
        {
            ...
            price: 85, isVegetarian: true, spiceLevel: client_1.SpiceLevel.MILD,
            menuType: client_1.MenuType.BOTH, category: 'Specialities', isAvailable: true,
        ...
        },
        {
            ...
            price: 80, isVegetarian: false, spiceLevel: client_1.SpiceLevel.HOT,
            menuType: client_1.MenuType.BOTH, category: 'Specialities', isAvailable: true,
        ...
        },
        {
            ...
            price: 80, isVegetarian: false, spiceLevel: client_1.SpiceLevel.MEDIUM,
            menuType: client_1.MenuType.BOTH, category: 'Specialities', isAvailable: true,
        ...
        },
        {
            ...
            price: 80, isVegetarian: true, spiceLevel: client_1.SpiceLevel.MEDIUM,
            menuType: client_1.MenuType.BOTH, category: 'Specialities', isAvailable: true,
        ...
        // ── Rice (BOTH) ──────────────────────────────────────────────────────
        {
            ...
            price: 100, isVegetarian: false, spiceLevel: client_1.SpiceLevel.HOT,
            menuType: client_1.MenuType.BOTH, category: 'Rice', isAvailable: true,
        ...
        // ── Starters & Snacks (BOTH) ─────────────────────────────────────────
        {
            ...
            price: 30, isVegetarian: false, spiceLevel: client_1.SpiceLevel.HOT,
            menuType: client_1.MenuType.BOTH, category: 'Starters', isAvailable: true,
        ...
        },
        {
            ...
            price: 20, isVegetarian: true, spiceLevel: client_1.SpiceLevel.MILD,
            menuType: client_1.MenuType.BOTH, category: 'Snacks', isAvailable: true,
        ...
        },
        {
            ...
            price: 20, isVegetarian: false, spiceLevel: client_1.SpiceLevel.MILD,
            menuType: client_1.MenuType.BOTH, category: 'Snacks', isAvailable: true,
        ...
        // ── Curries (DAILY) ──────────────────────────────────────────────────
        {
            ...
            price: 100, isVegetarian: true, spiceLevel: client_1.SpiceLevel.MEDIUM,
            menuType: client_1.MenuType.DAILY, category: 'Curries', isAvailable: true,
        ...
        },
        {
            ...
            price: 100, isVegetarian: false, spiceLevel: client_1.SpiceLevel.MILD,
            menuType: client_1.MenuType.DAILY, category: 'Curries', isAvailable: true,
        ...
        // ── Breakfast (DAILY) ────────────────────────────────────────────────
        {
            ...
            price: 50, isVegetarian: true, spiceLevel: client_1.SpiceLevel.MILD,
            menuType: client_1.MenuType.DAILY, category: 'Breakfast', isAvailable: true,
        ...
        // ── Friday Special only (FRIDAY) ─────────────────────────────────────
        {
            ...
            price: 85, isVegetarian: true, spiceLevel: client_1.SpiceLevel.MILD,
            menuType: client_1.MenuType.FRIDAY, category: 'Specialities', isAvailable: true,
        ...
        },
        {
            ...
            price: 50, isVegetarian: true, spiceLevel: client_1.SpiceLevel.MILD,
            menuType: client_1.MenuType.FRIDAY, category: 'Breakfast', isAvailable: true,
        ...
        // ── Drinks (DAILY) ───────────────────────────────────────────────────
        {
            ...
            price: 35, isVegetarian: true, spiceLevel: client_1.SpiceLevel.MILD,
            menuType: client_1.MenuType.DAILY, category: 'Drinks', isAvailable: true,
